    ...
    return (
        <Link
            ...
            className={`w-full flex items-start ps-3 pe-4 py-2 border-l-4 ${
                active
                    ? 'border-aqua  dark:border-aqua  text-gray-100  dark:text-aqua  bg-aqua dark:bg-aqua/50 focus:text-aqua  dark:focus:text-aqua  focus:bg-aqua  dark:focus:bg-aqua  focus:border-aqua  dark:focus:border-aqua '
