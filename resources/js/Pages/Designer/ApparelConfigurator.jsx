...
export default function Configurator({ auth, product }) {
    ...
    return (
        <>
            ...
            <div className='p-1'>
                <div className={` transition-all duration-300 h-full fixed inset-y-0 flex flex-col gap-4 items-start justify-center left-0 top-0 p-2`}>
                    ...
                    <div className={`mt-4  ${isExpanded ? 'translate-x-0' : '-translate-x-[60px]'} transition-all dark:text-gray-100  me-2 flex flex-row items-center justify-center`}>
                        ...
                        <div className="flex flex-col gap-4 items-center bg-gray-100 dark:bg-zinc-800 p-1 rounded-lg">
                            ...
                            {tutorialMode && (
                                <div className="bg-gray-50 absolute left-[90px] w-[200px] top-0 dark:bg-zinc-900 rounded-lg p-4">
                                    <h6>Avatar</h6>
                        ...
                        <button
                            ...
                            className="p-2 text-gray-800 bg-gray-100 dark:bg-zinc-800 rounded-r-lg dark:text-white z-50"
                    ...
                    <div className={` ${isExpanded2 ? 'translate-x-0' : '-translate-x-[60px]'}  transition-all dark:text-gray-100  me-2 flex flex-row items-center justify-center`}>
                        ...
                        <div className="flex flex-col gap-4 items-center bg-gray-100 dark:bg-zinc-800 p-2 rounded-lg">
                            ...
                            {tutorialMode && (
                                <div className="bg-gray-50 absolute left-[90px] w-[300px] bottom-0 dark:bg-zinc-900 rounded-lg p-4">
                                    <h6>Elements</h6>
                ...
                <div className="fixed inset-x-0 lg:left-auto right-0 lg:inset-y-0  bottom-0  flex flex-col lg:flex-row lg:gap-4 items-center justify-center ">
                    <div className={`${showProperties ? 'block' : 'hidden'} bg-gray-100 dark:bg-zinc-800 dark:text-gray-100 p-6 rounded-lg shadow-lg`}>
                    ...
                    <div className='dark:text-gray-100 w-full lg:w-auto flex lg:flex-col gap-8  items-center dark:bg-zinc-800 bg-gray-100 rounded-lg p-2'>

                        <div className='text-center flex flex-col items-center w-full' onClick={() => toggleTab('1')}>
                            <IconColorSwatch />
                            <small>Cloth</small>
                        </div>
                        <div className='text-center flex flex-col items-center w-full' onClick={() => toggleTab('2')}>
                            <IconShape />
                            <small>Objects</small>
                        </div>
                        <div className='text-center flex flex-col items-center w-full' onClick={() => toggleTab('3')}>
                            <IconShirt />
                            <small>Designs</small>
                        </div>
